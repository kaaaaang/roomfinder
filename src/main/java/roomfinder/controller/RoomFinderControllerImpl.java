...
public class RoomFinderControllerImpl implements RoomFinderController {
    ...
    public List<String> findRoom(@RequestParam String startDate, @RequestParam String endDate,
        ...
        return roomAvailabilityService.getAllAvailableRooms(roomAvailabilityService.getAllRooms(), start, end, isCasual);
    }
